...
var CodeManager = (function () {
    ...
    CodeManager.prototype.getCodeFileAndExecute = function (editor, fileExtension, executor, appendFile) {
        ...
        var ignoreSelection = this._config.get('ignoreSelection');
        if ((selection.isEmpty || ignoreSelection) && !editor.document.isUntitled) {
            ...
            if (this._config.get('saveAllFilesBeforeRun')) {
                return vscode.workspace.saveAll().then(function () {
            ...
            var text = (selection.isEmpty || ignoreSelection) ? editor.document.getText() : editor.document.getText(selection);
